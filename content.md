# content.md — WWUWH copy deck (WWUWH structure + original inspirational copy)

> Notes:
> - Facts (sessions, dates, policies, sponsors) must remain accurate.
> - Most copy below is *paraphrased* from the current WWUWH site to keep it clean + modern, with added inspirational lines for the new build.
> - Keep headings short (Integrated-style), with minimal paragraphs and high scannability.
...
### Tagline (primary)
South London club, hosting, coaching and games.

### Optional taglines (rotating / secondary)
- Breathe deeper. Play harder.
- One team. One breath. One goal.
- Fast hands. Calm minds. Full lungs.
- Under the surface, we move as one.
...
### Utility microcopy
- “Please register session attendance by enrolling with Spond.”
- “Check Spond for the latest session availability and updates.”
...
### Hero
**H1:** WEST WICKHAM UNDERWATER HOCKEY  
**Subhead:** South London club, hosting, coaching and games.  
**Primary CTA:** Enrol with Spond  
**Scroll cue:** Scroll

**Optional hero kicker lines (choose one):**
- Built in 1973. Still chasing the puck.
- Underwater hockey (Octopush) — speed, teamwork, and breath-hold.

### Sessions (must be prominent)
**Section title:** Sessions  
**Intro line (short):** Choose your night. Join the team.

**Session card template**
- Day label (chip): Wednesday / Thursday / Sunday
- Audience: Members & Guests (Wed/Thu) | Juniors only (Sun)
- Time:
- Venue:
- Address:
- CTA: Enrol with Spond
- Optional link: Open in maps
...
**Attendance note (below cards):**  
Please register session attendance by enrolling with Spond.

### 01 / 02 / 03 (signature scroll chapter section)
**Section title:** The game beneath the surface

**01 — PLAY**  
Short copy: Fast-paced, team-first underwater hockey at the bottom of the pool.  
Micro line: Learn the rhythms. Find your space. Move the puck.

**02 — COACH**  
Short copy: Skills, positioning, and tactics — built one session at a time.  
Micro line: Better control. Smarter decisions. Cleaner shifts.

**03 — COMPETE**  
Short copy: Local, national and European tournaments — and the friendships that come with them.  
Micro line: Turn training into teamwork. Turn teamwork into results.

### Quick links (home tiles)
- New to UWH? → Our Story (Introduction to the Sport)
- What kit do I need? → Kit Guide
- Ready to join? → Membership
- What’s coming up? → Events
- Find us online → Connect

### Home closing CTA
**Title:** Ready to get involved?  
**Line:** Start with a session. We’ll help you with the rest.  
**CTA:** Enrol with Spond
...
### About intro
**Title:** About WWUWH  
**Copy:** Founded in 1973, West Wickham is an inclusive club for social and competitive players. Whether you’re brand new or chasing tournaments, you’ll find a place in the team.

### About navigation tiles
- Our Story
- Player of the Year
- Ladies Club
- Juniors Club
...
**Title:** Kit Guide  
**Copy:**  
You don’t need everything on day one — but the right kit makes the sport safer, more comfortable, and more fun. Ask the team for guidance before buying, and always follow BOA guidelines.

**Starter kit (for first sessions)**
- Mask
- Snorkel
- Fins
...
## PRIVACY + COOKIES (short site-level copy)

### Cookie banner
**Title:** This website uses cookies.  
**Copy:** We use cookies to analyse website traffic and optimise your website experience. By accepting our use of cookies, your data will be aggregated with all other user data.  
**Buttons:** Decline | Accept

### Privacy policy page
> Keep a dedicated Privacy Policy page. If you want to reuse the existing policy verbatim, copy it from the current WWUWH site and place it into `privacy-policy.md` (or equivalent).
